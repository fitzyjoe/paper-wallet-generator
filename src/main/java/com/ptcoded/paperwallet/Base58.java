...
public class Base58
{
     ...
     * @return the base58-encoded string
     */
    public static String encodeChecked(int version, byte[] payload) throws NoSuchAlgorithmException
    {
        ...
        digest.update(addressBytes, 0, payload.length + 1);
    ...
    public static byte[] decodeChecked(String input) throws Exception
    {
        ...
        if (decoded.length < 4)
        {
            throw new Exception("Invalid data length. Input too short: " + decoded.length);
        }
